...
public class C01_Iframe extends TestBase {
    ...
    public void iframe() {
       ...
       //Ayrica 'Applications lists' yazisinin sayfada oldugunu test edelim
        driver.switchTo().frame(0); //-->Driver'i index kullanarak iframe gecis yaptirdik.
        bekle(2);
       ...
       //Son olarak footer(ana sayfadaki)(sayfanin en altindaki) daki 'Povered By' yazisini varligini test edilip
